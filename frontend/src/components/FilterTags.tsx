...
const FilterTags = () => {
  ...
  return (
    <div className="w-full pb-10 dark:text-white flex flex-col gap-5 select-none">
      <h1 className="flex flex-col items-center justify-center text-3xl font-bold">
        Filter Tags
      </h1>

      {/* tag/filter selector */}
      <div className="w-1/2 max-md:w-9/12 mx-auto border dark:border-gray-800 rounded-lg p-2 flex flex-col gap-3 justify-between shadow-lg">
        <div
